...
export default class PreloadScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image(TextureKeys.Title2, 'assets/images/S2/questionTitle.png');
        ...
        // -- Scene 1 Assets 4 --
        this.load.image(TextureKeys.S4, 'assets/images/S4/4.png');
        this.load.image(TextureKeys.Title4, 'assets/images/S4/Question.png');
