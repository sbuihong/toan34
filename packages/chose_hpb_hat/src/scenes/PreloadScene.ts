...
export default class PreloadScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image(TextureKeys.Number, 'assets/images/S1/number.png');
        this.load.image(TextureKeys.Dice, 'assets/images/S1/dice.png');

        // --- Scene 1 Assets 1 ---
        this.load.image(TextureKeys.Hat, 'assets/images/S1/hat.png');
        this.load.image(TextureKeys.Title1, 'assets/images/S1/questionTitle.png');
        this.load.image(TextureKeys.Ans1, 'assets/images/S1/ans1.png');
        this.load.image(TextureKeys.Ans2, 'assets/images/S1/ans2.png');
