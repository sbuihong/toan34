...
export default class Scene3 extends Phaser.Scene {
    ...
    create() {
        ...
        // SDK Integration
        // game.setTotal(3); // Defined in Scene 1
        (window as any).irukaGameState = {
            startTime: Date.now(),
            currentScore: 0,
        };
        sdk.score(this.score, 0);
        sdk.progress({ levelIndex: 2, total: 3 }); // index 2 for Scene 3
    ...
    private createLevel() {
        // Load cấu hình level từ JSON - CHANGED TO S3 CONFIG
    ...
    private playIntroSequence() {
        ...
        // COULD CHANGE VOICE IF NEEDED
        playVoiceLocked(null, AudioKeys.VoiceIntroS3); 
