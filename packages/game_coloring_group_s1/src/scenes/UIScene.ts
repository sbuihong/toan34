...
export default class UIScene extends Phaser.Scene {
    ...
    private currentSelectedColor: number = 0;
    ...
    private createUI() {
        ...
        if (this.sceneKey === SceneKeys.Scene2) {
            ...
            bannerKey = TextureKeys.S3_Banner;
        } else if (this.sceneKey === SceneKeys.Scene4) {
             bannerKey = TextureKeys.S4_Banner;
        }
    ...
    public updateSceneKey(newKey: string) {
        this.sceneKey = newKey;
