...
export default class Scene2 extends Phaser.Scene {
    ...
    init(data?: { isRestart: boolean }) {
        ...
        // Scene 2 luôn tự chạy vì đã tương tác ở Scene 1
    ...
    create() {
        ...
        sdk.progress({ levelIndex: 1, total: 1 });
    ...
    private handlePartComplete(
        ...
        if (remainingCorrectAnswers === 0) {
            ...
            sdk.progress({
                levelIndex: 1, // Level complete -> set index + 1 if multi-level, here just complete
                total: 1,
                score: this.score,
            });
