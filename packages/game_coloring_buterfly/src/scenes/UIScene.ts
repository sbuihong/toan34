...
export default class UIScene extends Phaser.Scene {
    ...
    private createUI() {
        ...
        this.so1Image = this.add.image(cx * 0.145, bannerY + 180, TextureKeys.So1).setScale(1).setOrigin(0.5, -0.1);
        this.diceImage = this.add.image(cx * 0.275, bannerY + 170, TextureKeys.Dice).setScale(1).setOrigin(0.5, -0.1);
