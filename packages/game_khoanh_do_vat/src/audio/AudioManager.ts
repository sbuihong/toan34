...
const SOUND_MAP: Record<string, SoundConfig> = {
    ...
    'voice-intro': { src: `${BASE_PATH}prompt/instruction.mp3`, volume: 1, html5: true }, // Fix lỗi bị ngắt tiếng
    'hint': { src: `${BASE_PATH}prompt/hint.mp3`, volume: 1.0, html5: true },

    // --- SFX correct answer
    'sfx-1' : {src: `${BASE_PATH}sfx/correct_answer_1.mp3`, volume: 1.0},
    'sfx-2' : {src: `${BASE_PATH}sfx/correct_answer_2.mp3`, volume: 1.0},
    'sfx-3' : {src: `${BASE_PATH}sfx/correct_answer_3.mp3`, volume: 1.0},
    'sfx-4' : {src: `${BASE_PATH}sfx/correct_answer_4.mp3`, volume: 1.0},
