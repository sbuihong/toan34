...
export default class UIScene extends Phaser.Scene {
    ...
    private createUI() {
        ...
        this.so1Image = this.add.image(cx * 0.38, bannerY + 180, TextureKeys.So1).setScale(0.9).setOrigin(0.5, -0.1);
        this.diceImage = this.add.image(cx * 0.5, bannerY + 170, TextureKeys.Dice).setScale(0.9).setOrigin(0.5, -0.1);
