...
export default class UIScene extends Phaser.Scene {
    ...
    private createUI() {
        ...
        this.bannerImage = this.add.image(cx, bannerY, bannerKey).setScale(0.7,0.8).setOrigin(0.5, -0.1);
        this.bannerText = this.add.image(cx, bannerY, textBannerKey).setScale(0.9).setOrigin(0.5, -0.35);
