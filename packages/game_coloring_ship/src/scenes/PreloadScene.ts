...
export default class PreloadScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image(TextureKeys.S1_6, 'assets/images/S1/6.png');
        this.load.image(TextureKeys.S1_7, 'assets/images/S1/7.png');
        this.load.image(TextureKeys.S1_8, 'assets/images/S1/8.png');
