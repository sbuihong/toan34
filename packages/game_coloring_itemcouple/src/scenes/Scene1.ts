...
export default class Scene1 extends Phaser.Scene {
    ...
    private runHandTutorial() {
        ...
        // --- UPDATE LOGIC VỊ TRÍ NÚT MÀU (VERTICAL) ---
        // Copy logic from UIScene (match UIScene updates)
        const paletteX = GameUtils.pctX(this, 0.84);
        const spacingY = GameUtils.pctY(this, 0.15);
