...
const SOUND_MAP: Record<string, SoundConfig> = {
    ...
    'instruction2': { src: `${BASE_PATH}prompt/instruction2.mp3`, volume: 1.0 },
    'instruction3': { src: `${BASE_PATH}prompt/instruction3.mp3`, volume: 1.0 },
    'instruction4': { src: `${BASE_PATH}prompt/instruction4.mp3`, volume: 1.0 },
    ...
    'voice_4': { src: `${BASE_PATH}prompt/voice4.mp3`, volume: 1.0 }
};
